...
public class mbItemRegister {
	...
	public static void registerItems() {
		...
		ItemSwordBleach = new ItemSwordMb("sword1", "Bleach Sword",new CharacteristicSword(50,10,0.2f), new int[] {0});
		LanguageRegistry.addName(ItemSwordBleach, "Bleach Sword");
		ItemSwordBleach2 = new ItemSwordMb("sword2", "Bleach Sword 2",new CharacteristicSword(49,30,0.5f), new int[] {1});
		...
		ItemSwordBleach6 = new ItemSwordMb("sword6", "Bleach Sword 6",new CharacteristicSword(45,65,0.9f), new int[] {4});
		LanguageRegistry.addName(ItemSwordBleach6, "Bleach Sword 6");
		CyanBlade = new ItemSwordMb("sword7", "Cyan blade",new CharacteristicSword(44,24,0.1f),new int[] {5});
