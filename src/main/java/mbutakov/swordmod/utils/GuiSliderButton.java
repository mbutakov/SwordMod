...
public class GuiSliderButton extends GuiButton {
	...
	public GuiSliderButton(GuiScreen parent, int id, int xPos, int yPos, String displayString, float sliderValue) {
	...
	public GuiSliderButton(GuiScreen parent, int id, int xPos, int yPos, float sliderValue) {
		this(parent, id, xPos, yPos, "", sliderValue);
		if(listener != null)
			listener.mouseDragged(this);
	}
	
	public GuiSliderButton(GuiScreen parent, int id, int xPos, int yPos, int width, int height, float sliderValue) {
		this(parent, id, xPos, yPos, "", sliderValue);
		this.width = width;
		this.height = height;
		if(listener != null)
