...
import mbutakov.swordmod.mbBlocksRegister;
...
import mbutakov.swordmod.client.render.RenderItemBlockChangeSkin;
...
public class ClientProxy extends CommonProxy {
	...
	public void Init() {
		...
		MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(mbBlocksRegister.blockChangeSkins), new RenderItemBlockChangeSkin());
